            ...
            <div className="mx-auto max-w-6xl px-6">
                ...
                <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-3">
                    ...
                    <Card className="relative">
                        <span className="bg-linear-to-br/increasing absolute inset-x-0 -top-3 mx-auto flex h-6 w-fit items-center rounded-full bg-[#9359FF] px-3 py-1 text-xs font-medium text-white ring-1 ring-inset ring-white/20 ring-offset-1 ring-offset-gray-950/5">Popular</span>
