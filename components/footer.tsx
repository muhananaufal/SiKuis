	...
	return (
		<footer className="border-b bg-white pt-20 dark:bg-transparent">
			...
			<div className="mx-auto max-w-5xl px-6">
				<div className="grid gap-12 md:grid-cols-3 md:gap-0 lg:grid-cols-3">
					<div className="grid grid-cols-2 gap-6 sm:grid-cols-4 md:col-span-4 md:row-start-1 lg:col-span-3">
